  ...
  return (
    <div className="z-10 mt-20 text-center md:mt-40 md:text-left rounded-3xl bg-clip-text">
        ...
        <div className="flex-col hidden md:flex c-space">
            ...
            animate="visible"
            transition={{delay: 1}}
            >Hi i'am Gabriel</motion.h1>
            <div className="flex flex-col items-start">
                <motion.p className="text-5xl font-medium text-neutral-300"
                 variants={variants}
                 initial="hidden"
                 animate="visible"
                 transition={{delay: 1.2}}> I am a passionate developer<br/> creating beautiful and functional websites.</motion.p>
                <motion.div 
                variants={variants}
                 initial="hidden"
                 animate="visible"
        ...
        <div className="flex- flex-col space-y-6 md:hidden">
            ...
            initial="hidden"
            animate="visible"
            transition={{delay: 1}}>Hi, I'm Gabriel</motion.p>
            <div>
